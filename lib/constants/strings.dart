class Strings {
  ...
  static const String BENEFITS_CREATING = 'Benefits of Creating an Account';
  static const String NEWS_AND_EXCLUSIVE_OFFERS = 'News and exclusive offers!';
  static const String NEWS_AND_EXCLUSIVE_OFFERS_INFO = 'Sign up to receive email updates on special promotions, new product announcements, gift ideas and more.';
  static const String ORDER_HISTORY = 'Order History';
  static const String ORDER_HISTORY_INFO = 'Receive important information about your order. You can even track it up to the minute it arrives.';
  static const String FASTER_CHECKOUT = 'Faster Checkout';
  static const String FASTER_CHECKOUT_INFO = 'Save your billing and shipping information to make it easier to buy your favorite gear.';
